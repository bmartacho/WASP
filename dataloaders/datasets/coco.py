...
class COCOSegmentation(Dataset):
    ...
    def __init__(self,
                 ...
                 year='2017'):
        super().__init__()
        ann_file = os.path.join(base_dir, 'images/annotations/instances_{}{}.json'.format(split, year))
        ids_file = os.path.join(base_dir, 'images/annotations/{}_ids_{}.pth'.format(split, year))
