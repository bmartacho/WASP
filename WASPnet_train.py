...
from utils.crf import crf_inference

import utils.convcrf
...
class Trainer(object):
    def __init__(self, args):
        ...
        optimizer = torch.optim.SGD(train_params, momentum=args.momentum,
                                    weight_decay=args.weight_decay, nesterov=args.nesterov)_
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            image, target, image_path = sample['image'], sample['label'], sample['path']
